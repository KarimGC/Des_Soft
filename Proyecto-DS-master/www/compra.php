...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO Lotes (Razonsocial, PesoLote, PrecioKilo, FechaEntrada, REEMO, Motivo, Consecutivo, Arete, Sexo, Meses, Clasif) 
    VALUES ('$razonSocial', $pesoLote, $precioKilo, '$fechaEntrada', '$reemo', '$motivo', '$consecutivo', '$arete', '$sexo', $meses, '$clasif')";
...
<div class="container mt-5">
    <h1>RESGISTRO DE ANIMALES</h1>
    <br><h4>Datos de la guia de transito</h4><br>

    <div class="mb-3">
        <label for="reemo" class="form-label">N.REEMO</label>
    ...
    <br><h4>Datos de origen y destino</h4><br>
    ...
    <div class="mb-3">
        ...
        <br>
        <br><h4>Datos de los bovinos</h4><br>
        ...
        <div class="mb-3">
            <label for="arete" class="form-label">Numero de arete</label>
            <input type="text" class="form-control" id="arete" name="arete" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="meses" name="meses" required>
        </div>

        <div class="mb-3">
            <label for="clasif" class="form-label">Clasificacion</label>
            <select class="form-control" id="clasif" name="clasif" required>
            <option value="Becerro(a)">Becerro(a)</option>
        ...
        <div class="mb-3">
            <label for="precioKilo" class="form-label">Precio por kg</label>
            <input type="text" class="form-control" id="precioKilo" name="precioKilo" required>
        </div>

        <div class="mb-3">
            <label for="pesoLote" class="form-label">Peso (kg)</label>
        ...
        <button type="submit" class="btn btn-primary btn-lg btn-success">Comprar Lote</button><br><br>
    </form>
</div>
