...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && isset($_GET['id_alimento'])) {
    ...
    $sql = "SELECT * FROM Dieta_A WHERE id_alimento = $id_alimento";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "UPDATE Dieta_A SET cantidad = $cantidad WHERE id_alimento = $id_alimento";
...
<div class="container mt-5">
    ...
    <form method="POST" action="editar_dieta_A.php">
